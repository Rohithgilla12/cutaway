...
import BloomViz from "./components/BloomViz";
...
<Figure
  number={2}
  label="bloom filter"
  caption="Coach: query non-members until you land a false positive — and notice members never miss. At ~12 keys the false-positive rate sits around 12%; reset and the bit array clears back to zero."
>
  <BloomViz client:visible />
</Figure>
...
- Martin Kleppmann, _Designing Data-Intensive Applications_, ch. 3 — SSTables, LSM trees, and the LSM-versus-B-tree comparison.
- Alex Petrov, _Database Internals_, Part I — LSM storage, memtable/SSTable flush, compaction, and read/write/space amplification.

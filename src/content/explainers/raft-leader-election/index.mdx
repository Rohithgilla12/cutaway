...
<Figure number={2} label="quorum overlap" caption="Coach: try to pick two majorities that don't overlap.">
...
That is the answer to the opening outage. The partitioned primary can keep _accepting_ writes all day; what it cannot do is _commit_ them, because commit requires a majority and the majority is on the other side of the break.
